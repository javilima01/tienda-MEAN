...
import { ArticulosCategoriaComponent } from './components/articulos-categoria/articulos-categoria.component';
...
const routes: Routes = [
  ...
  { path: 'filtros/:categoria', component: ArticulosCategoriaComponent },
